...
public class Number_10825 {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(arr, (e1, e2) -> {
            int language1 = Integer.parseInt(e1[1]);
            int language2 = Integer.parseInt(e2[1]);
            if (language1 == language2) {
                int english1 = Integer.parseInt(e1[2]);
                int english2 = Integer.parseInt(e2[2]);
                if (english1 == english2) {
                    int math1 = Integer.parseInt(e1[3]);
                    int math2 = Integer.parseInt(e2[3]);
                    if (math1 == math2) {
